...
namespace TransporteWeb.Migrations
{
    ...
    [Migration("20241004042012_pagamentoMultas")]
    partial class pagamentoMultas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransporteWeb.Models.ConfirmacaoPresenca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ConfirmacaoPresencas");
                });
            ...
            modelBuilder.Entity("TransporteWeb.Models.Agendamento", b =>
                {
                    ...
                    b.HasOne("TransporteWeb.Models.Ponto", "ponto")
                        .WithMany()
            ...
            modelBuilder.Entity("TransporteWeb.Models.ConfirmacaoPresenca", b =>
                {
                    b.HasOne("TransporteWeb.Models.Agendamento", "Agendamento")
                        .WithMany()
